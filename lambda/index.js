...
import charactersMessages from "./messages/charactersMessages.json";
import {
  whatsIntentAbout,
  charactersInfo,
} from "./messages/commonMessages.json";
...
const WhatsTheIntentAbout = {
  ...
  handle(handlerInput) {
    const speakOutput = whatsIntentAbout;
    return handlerInput.responseBuilder
      .speak(speakOutput)
      .reprompt(speakOutput)
      .getResponse();
...
const InfoAboutCharacters = {
  ...
  handle(handlerInput) {
    const speakOutput = charactersInfo;
    return handlerInput.responseBuilder
      .speak(speakOutput)
      .reprompt(speakOutput)
      .getResponse();
